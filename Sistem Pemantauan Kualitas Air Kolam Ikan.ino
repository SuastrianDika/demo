...
void loop()
{
  ...
  if(millis() - printTime > printInterval)   //Every 800 milliseconds, print a numerical, convert the state of the LED indicator
  {
      ...
      Serial.print("  suhu air Node 1 =");
      Serial.print(suhuSekarang);   

Float TAN = 0.8876*((0.0278/(1+pow(10,(7.688- pH))))+(1.1994/(1+pow(10,(pH-7.688))))*(2.126*pow(10,(0.028*(20-max(T,7)))))); //rumus mencari amonia

      //Amonia
      Serial.print("  Amonia Node 1 =");
      Serial.println(nilaiAmonia,2);
      delay(1000);
